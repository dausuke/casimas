        ...
        <div class="row w-100 justify-content-center">
            <div class="col-4 item-list">
                ...
                <div class="row m-0 p-0 w-100 ">
                    <div class="col-12 d-flex justify-content-start form-check list" v-for="(content, index) in allItem" :key="index">
                        <input class="form-check-input" type="radio" :id="'itemId'+index" :value="content.item_id" v-model="itemId" />
            ...
            <div class="form-group col-8">
                ...
                <div class="upfile-area p-0 d-flex justify-content-center">
                    <div class="pleview-area" v-show="photo[0] != null">
                    ...
                    <div class="pleview-area" v-show="photo[1] != null">
                    ...
                    <div class="pleview-area" v-show="photo[2] != null">
                    ...
                    <div class="pleview-area" v-show="photo[3] != null">
...
export default {
    ...
    methods: {
        ...
        submitItemImg: function() {
            ...
            if (this.photo[0]) {
                upImgData.append('photo1', this.photo[0]);
            }
            if (this.photo[1]) {
                upImgData.append('photo2', this.photo[1]);
            }
            if (this.photo[2]) {
                upImgData.append('photo3', this.photo[2]);
            }
            if (this.photo[3]) {
                upImgData.append('photo4', this.photo[3]);
            }
            upImgData.append('item_id', this.itemId);
            upImgData.append('token', 'item');
            myHttpClient
                .post(baseUrl + 'admin.php', upImgData, {
                    headers: {
